    ...
    <>
      <aside
        className={`shrink-0 flex flex-col bg-[var(--surface)] border-r border-[var(--border)] transition-[width] duration-200 ease-out ${
          collapsed ? "w-12 min-w-[3rem] overflow-hidden md:w-12 md:min-w-[3rem]" : "w-[260px] min-w-0"
        }`}
      >
        <div className="flex items-center gap-2 h-12 px-3 border-b border-[var(--border)] shrink-0 min-w-0">
          <button
            type="button"
          ...
          {!collapsed && (
            <h2 className="text-[15px] font-semibold text-[var(--text)] truncate flex-1 min-w-0">
              Seeknimbly HR
            </h2>
          )}
        </div>
